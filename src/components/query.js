        ...
        <div className="grid place-items-center">
            ...
            <div className={"relative flex flex-row gap-6 items-center justify-center w-" + props.width}>
                <div className="flex flex-row items-center justify-left rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500">
                    ...
                    <input onChange={(event) => props.QueryManager(event.target.value)} type="text" id="default-search" className={"focus:outline-blue-600 rounded-lg block p-4 pl-12 text-sm text-gray-900 w-" + props.width} placeholder={props.placeholder} />                    
                </div>
            </div>
        </div>
        );

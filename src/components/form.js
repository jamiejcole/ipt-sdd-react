      ...
      return (
        <form onSubmit={this.handleSubmit}>
          <label class="block mb-2 text-sm font-medium text-gray-900">
            {this.props.title}: 
            <input class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" type="text" value={this.state.value} onChange={this.handleChange} />
          </label>

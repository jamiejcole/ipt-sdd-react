    ...
    return (
      <div className="grid place-items-center">
          <form onSubmit={handleSubmit}>
              <h3 className="mb-5 text-lg font-medium text-gray-900 dark:text-white">{props.title}</h3>
              <ul className="grid gap-6 w-full md:grid-cols-2 text-left">
                  <li>
                      <input type="radio" id="hosting-small" name="hosting" value="hosting-small" className="hidden peer" required="" defaultChecked={true} />
